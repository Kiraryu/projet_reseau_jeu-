...
void invalidate_invitation(Player* rejected_player_id){ // invalidate the invitations you have SENT to other players // call reject_invitation of rejected_player_id with this as argument (demande à un joueur à qui on avait envoyé une invitation de l'invalider en nous la refusant)
